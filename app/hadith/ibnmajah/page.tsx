...
export default function IbnMajahPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      setShareUrl(`${window.location.origin}/hadith/ibnmajah`);
    }
  }, []);
  ...
  const fetchHadiths = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/hadith/ibnmajah?${params}`)
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold text-indigo-600">সুনান ইবনে মাজাহ</h1>
              <ShareButton
                title="সুনান ইবনে মাজাহ"
                text="ইসলামিক গাইড অ্যাপে সুনান ইবনে মাজাহ পড়ুন।"
                url={shareUrl}
                variant="outline"
                size="sm"
              >
        ...
        <Card className="mb-8 shadow-lg">
          <CardHeader className="bg-gradient-to-r from-indigo-500 to-indigo-700 text-white">
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>সুনান ইবনে মাজাহ - ইমাম ইবনে মাজাহ (রহ.)</span>
            </CardTitle>
          </CardHeader>
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <p className="text-sm text-gray-600">মোট হাদিস: ৪,৩৪১</p>
                <p className="text-sm text-gray-600">মোট অধ্যায়: ৩৭</p>
                <p className="text-sm text-gray-600">সময়কাল: ৮২৪-৮৮৭ খ্রি.</p>
              </div>
              <div>
          ...
          <Card className="mb-8 shadow-lg">
            ...
            <CardContent className="space-y-6 p-6">
              ...
              <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 p-6 rounded-lg border-l-4 border-indigo-500">
                <p className="text-right text-2xl font-arabic leading-loose text-indigo-700 dark:text-indigo-300">
