...
export default function AbuDawudPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      setShareUrl(`${window.location.origin}/hadith/abudawud`);
    }
  }, []);
  ...
  const fetchHadiths = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/hadith/abudawud?${params}`)
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold text-orange-600">সুনান আবু দাউদ</h1>
              <ShareButton
                title="সুনান আবু দাউদ"
                text="ইসলামিক গাইড অ্যাপে সুনান আবু দাউদ পড়ুন।"
                url={shareUrl}
                variant="outline"
                size="sm"
              >
        ...
        <Card className="mb-8 shadow-lg">
          <CardHeader className="bg-gradient-to-r from-orange-500 to-orange-700 text-white">
            <CardTitle className="flex items-center space-x-2">
              ...
              <span>সুনান আবু দাউদ - ইমাম আবু দাউদ (রহ.)</span>
            </CardTitle>
          </CardHeader>
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <p className="text-sm text-gray-600">মোট হাদিস: ৫,২৭৪</p>
                <p className="text-sm text-gray-600">মোট অধ্যায়: ৪৩</p>
                <p className="text-sm text-gray-600">সময়কাল: ৮১৭-৮৮৯ খ্রি.</p>
              </div>
              <div>
          ...
          <Card className="mb-8 shadow-lg">
            ...
            <CardContent className="space-y-6 p-6">
              ...
              <div className="bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 p-6 rounded-lg border-l-4 border-orange-500">
                <p className="text-right text-2xl font-arabic leading-loose text-orange-700 dark:text-orange-300">
